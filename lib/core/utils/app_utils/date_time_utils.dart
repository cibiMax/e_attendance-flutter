...
class DateTimeUtils {
  ...
  static String formattedHistoryDate(String date) => DateFormat(
    "dd \n MMMM,\n yyyy",
  ).format(DateFormat("dd/MM/yyy").parse(date));
  static int dateToTimeStamp(DateTime date) => date.millisecondsSinceEpoch;
  static String timeStampToFormattedDateString(int timeStamp) =>
